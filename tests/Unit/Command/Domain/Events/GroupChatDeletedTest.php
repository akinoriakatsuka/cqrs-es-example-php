...
class GroupChatDeletedTest extends TestCase
{
    ...
    private GroupChatDeletedFactory $group_chat_deleted_factory;
    ...
    protected function setUp(): void
    {
        ...
        $this->group_chat_deleted_factory = new GroupChatDeletedFactory(
    ...
    public function test_fromArrayでデシリアライズできる(): void
    {
        ...
        $event = $this->group_chat_deleted_factory->fromArray($data);
    ...
    public function test_ラウンドトリップでデータが保持される(): void
    {
        ...
        $restored_event = $this->group_chat_deleted_factory->fromArray($array);
